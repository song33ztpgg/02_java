...
public class PreparedTest {
	...
	private static final String URL = "jdbc:oracle:thin:@//local host:1521/XE"; 
	private static final String MYSQL_URL = "jdbc:mysql://127.0.0.1:3306/emp?severTimezone=Asia/Seoul";
...
//						+"FROM emp e" 
//						+"ORDER BY e.ename"; 
			System.out.println("조회할 대상의 job을 입력하시오"); 
